		...
		<td>
		    ...
		    <p><br></p>
				<%
					...
					String sql="select * from suggestion order by wdate desc";
					int count=1;
							...
							<%
								while(rs.next()){%>
										<tr class="menu" style="background-color:white;font-size:1.2em;" id="move">
											...
											<td align="center" style="padding:0.5%;"><a id="mm" href="sugView.jsp?title=<%=rs.getString("title")%>"><%=rs.getString("title") %></a></td>
								...
								<tr>
									<td colspan=4>
										<p><br><br><br></p>
										<div align="right" >
											<a href="sugViewEnroll.jsp"><input type="button" id="enroll" class="btn" value="글쓰기"></a>
										</div>
									</td>
								</tr>
							</table>
